...
export class CodeEditorApp extends App {
    ...
    _saveFileAs() { // Devuelve true si se guardó, false si se canceló o falló
        ...
        // Validar extensión es opcional, el usuario podría querer guardar sin extensión
        // if (!trimmedPath.match(/\.(txt|html|css|js|md|json)$/i)) {
        //     if (!confirm("El archivo no tiene una extensión común. ¿Guardar de todas formas?")) return false;
        // }
    ...
    _runHtmlPreview() {
        ...
        if (this.previewWindow) {
            ...
            // Es importante el sandbox para seguridad, aunque limita algunas cosas.
            const iframeHTML = `
                <iframe
